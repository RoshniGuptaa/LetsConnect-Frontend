...
const CreateGroup = () => {
    ...
    const handleRemoveMember = (item) => {
      const newGroupMembers = new Set(groupMember);
      newGroupMembers.delete(item);
      setGroupMember(newGroupMembers);
  };
             ...
             <div className='bg-white overflow-y-scroll h-[50.2vh]'>
              {query && [1,1,1,1,1].map((item)=><div onClick={
               ...
               <div className='bottom-10 py-10 bg-slate-200   flex items-center justify-center'>
                <div className='bg-[#3e226e] rounded-full p-4 cursor-pointer ' onClick={()=>{
                  setNewGroup(true)
                }}>
