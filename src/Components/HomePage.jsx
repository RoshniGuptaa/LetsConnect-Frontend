    ...
    <div className='relative'>
     ...
     <div className='flex bg-[#f0f2f5] h-[90vh] absolute top-6 left-[2vw] w-[96vw]'>
        <div className='left w-[30%] bg-[#003C43] h-full'>
         ...
         {!isProfile && <div className='w-full'>
              ...
              { <div className=' flex justify-between items-center p-3'>
                 <div onClick={handleNavigate} className='flex item-center space-x'>
                    <img className='rounded-full w-10 h-10 cursor-pointer' src="https://cdn.pixabay.com/photo/2018/01/12/10/19/fantasy-3077928_1280.jpg" alt="" />
                    <p>username</p>
                 </div>
              ...
              <div className='bg-white overflow-y-scroll h-[76.8vh] px-3'>
               ...
               <div onClick={handleClickOnChartCard}>  <hr /> <ChatCard/></div>))}
        ...
        {/* Default WhatsApp page */}
          {!currentChat && <div className='w-[70%]  bg-[#f0f2f5] flex flex-col  items-center justify-center h-full '>
           <div className=' max-w-[70%] text-center'>
              <img  src ={img} alt="no no" />
              <h1 className='text-4xl text-gray-600'>LetsConnect</h1>
              <p className='my-9'> transforming society and shaping the future through chat.</p>
           </div>
           </div>}

           {/* Message part */}
           {currentChat && <div className='w-[70%] relative bg-[#E3FEF7]' >
              <div className='header absolute top-0 w-full bg-[#003C43]'>
            <div className='flex justify-between'>
               <div className='py-3 px-3 flex space-x-4 flex item-center '>
                  <img className='w-10 h-10 rounded-full' src="https://cdn.pixabay.com/photo/2021/08/25/20/42/field-6574455_640.jpg" alt="" />
                  <p>username</p>
               </div>
               ...
               <div className='footer absolute bottom-0 w-full py-3 text-2xl bg-[#f0f2f5]'>
                  ...
                  < input className='py-2 couline-none border-none bg-white pl-4 rounded-md w-[85%]' type='text' onChange={(e)=>setContent(e.target.value)} placeholder='type message' value={content}
                  onKeyPress={(e)=>{
                     if(e.key==='Enter'){
